...
@st.cache_resource
def load_models():
    recovery_model = joblib.load("LightGBM_recovery_time.joblib")
    diet_model = joblib.load("lr_diet_model_realistic.joblib")
    recovery_scaler = joblib.load("recovery_scaler_realistic.joblib")
    diet_scaler = joblib.load("diet_scaler_realistic.joblib")
