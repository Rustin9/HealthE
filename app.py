...
@st.cache_resource
def load_models():
    recovery_model = joblib.load("C:/Users/rohan/Jupyter Notebook/AIDI/CAPSTONE/healthcare_app/models/LightGBM_recovery_time.joblib")
    diet_model = joblib.load("C:/Users/rohan/Jupyter Notebook/AIDI/CAPSTONE/healthcare_app/models/lr_diet_model_realistic.joblib")
    recovery_scaler = joblib.load("C:/Users/rohan/Jupyter Notebook/AIDI/CAPSTONE/healthcare_app/models/recovery_scaler_realistic.joblib")
    diet_scaler = joblib.load("C:/Users/rohan/Jupyter Notebook/AIDI/CAPSTONE/healthcare_app/models/diet_scaler_realistic.joblib")
...
if sidebar_choice == "🍎 Predict Diet Plan":
    ...
    water_intake_liters = st.slider("Daily Steps", 1, 5, 3)
